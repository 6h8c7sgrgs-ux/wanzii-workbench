...
/* ---------- 寿山石分类 ---------- */
const ShoushanTypes = [
  { name: '田黄石', desc: '寿山石中的王者，温润如玉，有萝卜丝纹', searchKw: '寿山石 田黄石 鉴别 赏析', knowledge: '万石之王，产于水田中，色如蛋黄，肌理隐现萝卜丝纹。以"温、润、凝、腻、细、结"六德著称，古有"一两田黄三两金"之说。' },
  { name: '芙蓉石', desc: '质地温润细腻，色彩丰富，有"石后"之称', searchKw: '寿山石 芙蓉石 特点 收藏', knowledge: '产于月洋山，质地如凝脂，色彩丰富（红、黄、白、五彩）。老坑芙蓉最为珍贵，入手有"冰凉感"，是寿山石中仅次于田黄的名种。' },
  { name: '善伯洞', desc: '晶莹凝润，有善伯晶、善伯尾等细分', searchKw: '寿山石 善伯洞 鉴别 特征', knowledge: '产于寿山善伯洞，质地晶莹凝润，色以红、黄为主。有"善伯晶"（透明度高）和"善伯尾"（色泽浓郁）等细分，肌理常见金砂点。' },
  { name: '水洞石', desc: '通灵凝腻，有红、黄、白多色', searchKw: '寿山石 水洞石 介绍', knowledge: '产于坑头洞水浸部分，质地通灵凝腻，色彩以红、黄、白为主，常有多色交织。因长期水浸，质地格外滋润。' },
  { name: '高山石', desc: '产量较大，色彩多样，质地温润', searchKw: '寿山石 高山石 分类 讲解', knowledge: '寿山石产量最大的品种，色彩丰富多样。按洞脉分有高山洞、高山晶、高山冻等，是入门寿山石最常见的品种。' },
  { name: '荔枝洞', desc: '质地通灵，有萝卜丝纹，近年备受追捧', searchKw: '寿山石 荔枝洞 收藏 价值', knowledge: '产于高山脉荔枝洞，质地通灵透澈，肌理有萝卜丝纹，色以白、黄为主。因矿脉枯竭，近年市场价格持续走高。' },
  { name: '旗降石', desc: '坚韧凝腻，色泽深沉，适合把玩', searchKw: '寿山石 旗降石 特点 把玩', knowledge: '产于旗降山，质地坚韧凝腻，色泽深沉以红、黄为主。韧性好，适合精雕细琢，是把玩件的上选石材。' },
  { name: '汶洋石', desc: '质地细腻，色泽淡雅，有冰纹', searchKw: '寿山石 汶洋石 介绍 特点', knowledge: '产于汶洋村，质地细腻温润，色泽淡雅偏白，肌理常见冰纹。外观接近芙蓉石，但润度稍逊，是性价比较高的品种。' }
];
...
/* ---------- 抖音爆款案例库 ---------- */
const DouyinHotCases = [
  {
    category: '生活vlog',
    title: '一人居治愈系vlog',
    desc: '记录独居日常的小确幸，暖色调画面+轻音乐',
    hooks: ['前3秒展现最美画面留人', '标题用"一个人也要好好生活"引发共鸣', '结尾留一句话引发评论区互动'],
    data: { plays: '500w+', likes: '80w+', comments: '3w+' },
   拆解: {
      选题: '独居生活是当下年轻人的共鸣点，治愈系内容自带传播力',
      结构: '黄金3秒美景 → 日常片段串联 → 金句收尾',
      音乐: '轻柔日系BGM，配合慢节奏画面',
      节奏: '每个镜头3-5秒，不拖沓，保持观看流畅感',
      互动: '结尾开放式问题"你一个人的时候喜欢做什么？"引导评论'
    },
    applicable: '适合做生活类、情感类内容，关键在于画面质感和情绪共鸣'
  },
  {
    category: '知识科普',
    title: '3分钟讲透一个历史冷知识',
    desc: '快节奏口播+趣味动画，把冷知识讲得有趣',
    hooks: ['开头抛出反常识问题"你知道吗？" ', '每30秒一个信息点保持新鲜感', '结尾抛悬念"下期更精彩"'],
    data: { plays: '800w+', likes: '120w+', comments: '5w+' },
    拆解: {
      选题: '反常识+冷知识天然吸引好奇心',
      结构: '抛问题 → 给答案 → 补充趣味细节 → 下期预告',
      音乐: '节奏感强的BGM，配合信息点切换卡点',
      节奏: '语速偏快，信息密度高，不留废话时间',
      互动: '评论区置顶提问"你还知道哪些冷知识？"'
    },
    applicable: '适合知识类、教育类账号，核心是信息密度和趣味性的平衡'
  },
  {
    category: '美食探店',
    title: '街头小吃沉浸式拍摄',
    desc: 'ASMR式收音+特写镜头，放大食物诱惑',
    hooks: ['开场就是食物特写+滋滋声', '全程无解说纯白噪音', '字幕标注店名地址'],
    data: { plays: '600w+', likes: '90w+', comments: '4w+' },
    拆解: {
      选题: '街头小吃受众广，沉浸式体验感强',
      结构: '食物特写 → 制作过程 → 成品展示 → 店铺信息',
      音乐: '无BGM，保留现场环境音和烹饪声',
      节奏: '慢节奏享受型，每个镜头5-8秒',
      互动: '字幕引导"评论区告诉我你想吃哪个"'
    },
    applicable: '适合美食类账号，关键是声音和画面的感官刺激'
  },
  {
    category: '情感共鸣',
    title: '给未来的自己写一封信',
    desc: '文字+唯美背景画面，走心文案引发情感共振',
    hooks: ['开头直接念信的第一句', '画面是日落/海边等治愈场景', '音乐渐强推向高潮'],
    data: { plays: '1000w+', likes: '200w+', comments: '10w+' },
    拆解: {
      选题: '情感类内容自带高传播属性，"给未来的自己"是经典母题',
      结构: '称呼 → 现状描述 → 期望与祝福 → 落款',
      音乐: '钢琴曲渐入，情感高潮处音乐推满',
      节奏: '慢节奏，每句话留3-5秒消化时间',
      互动: '"在评论区写下你想对未来的自己说的话"'
    },
    applicable: '适合情感类、文艺类账号，文案质量是核心'
  },
  {
    category: '技能教学',
    title: '30秒学会一个实用技巧',
    desc: '竖屏演示+快节奏讲解，短平快教学',
    hooks: ['"30秒教会你"直接亮价值', '演示过程加速播放', '成品对比展示效果'],
    data: { plays: '700w+', likes: '100w+', comments: '2w+' },
    拆解: {
      选题: '实用技巧类内容完播率高，易于收藏转发',
      结构: '亮价值 → 分步演示 → 效果对比 → 引导关注',
      音乐: '节奏明快的BGM配合加速画面',
      节奏: '极快，30秒内完成教学，不浪费一秒',
      互动: '"评论区告诉我你想学什么"'
    },
    applicable: '适合技能教学类账号，关键是简洁和可操作性'
  },
  {
    category: '反差变装',
    title: '素人变装挑战',
    desc: '前半段朴素后半段惊艳，反差感拉满',
    hooks: ['前半段刻意素颜朴素', '音乐卡点瞬间变装', '前后对比产生视觉冲击'],
    data: { plays: '2000w+', likes: '300w+', comments: '15w+' },
    拆解: {
      选题: '反差感是短视频最有效的流量密码之一',
      结构: '素颜出场 → 遮挡转场 → 精致变装 → 定格展示',
      音乐: '前半段静音或低沉，变装瞬间切换高能BGM',
      节奏: '前5秒平淡，变装瞬间爆发，定格3秒',
      互动: '"打分1-10分"引导评论区互动'
    },
    applicable: '适合颜值类、时尚类账号，核心是变装前后的视觉反差'
  }
];

/* ---------- 抖音爆款拆解维度模板 ---------- */
const DouyinAnalysisTemplate = [
  { dimension: '选题角度', icon: '🎯', desc: '为什么选这个话题？击中了什么痛点或痒点？' },
  { dimension: '标题文案', icon: '✍️', desc: '标题用了什么套路？悬念/数字/反问/共鸣？' },
  { dimension: '前3秒钩子', icon: '🪝', desc: '开头如何留人？视觉冲击/悬念/金句？' },
  { dimension: '内容结构', icon: '🏗️', desc: '整体怎么编排？起承转合的节奏如何？' },
  { dimension: '音乐配合', icon: '🎵', desc: 'BGM选了什么风格？如何与画面配合？' },
  { dimension: '剪辑节奏', icon: '✂️', desc: '快节奏还是慢节奏？镜头时长如何？' },
  { dimension: '互动设计', icon: '💬', desc: '如何引导评论/点赞/转发？' },
  { dimension: '可复用点', icon: '♻️', desc: '哪些元素可以借鉴到自己的内容中？' }
];
  ...
  categories: [
    {
      ...
      icon: '🌸',
      poems: [
        { title: '春夜喜雨', author: '杜甫', dynasty: '唐', text: '好雨知时节，当春乃发生。随风潜入夜，润物细无声。', appreciation: '写春雨的不朽名篇，"润物细无声"已成千古传诵的意象，温柔而深沉' },
        { title: '晓出净慈寺送林子方', author: '杨万里', dynasty: '宋', text: '毕竟西湖六月中，风光不与四时同。接天莲叶无穷碧，映日荷花别样红。', appreciation: '夏日西湖的壮美，色彩浓烈，画面感极强' },
        { title: '山行', author: '杜牧', dynasty: '唐', text: '远上寒山石径斜，白云生处有人家。停车坐爱枫林晚，霜叶红于二月花。', appreciation: '秋色绚烂，"霜叶红于二月花"是写秋最美的句子之一' },
        { title: '江雪', author: '柳宗元', dynasty: '唐', text: '千山鸟飞绝，万径人踪灭。孤舟蓑笠翁，独钓寒江雪。', appreciation: '写冬的极致，空旷寂静中透着孤傲之气' }
      ]
    },
    {
      name: '人生感悟',
      icon: '🌙',
      poems: [
        { title: '水调歌头·明月几时有', author: '苏轼', dynasty: '宋', text: '人有悲欢离合，月有阴晴圆缺，此事古难全。但愿人长久，千里共婵娟。', appreciation: '中秋词的巅峰，旷达与深情并存，千古传唱' },
        { title: '将进酒', author: '李白', dynasty: '唐', text: '君不见黄河之水天上来，奔流到海不复回。人生得意须尽欢，莫使金樽空对月。', appreciation: '李白的豪迈达到极致，气势磅礴，读之令人热血沸腾' },
        { title: '定风波·莫听穿林打叶声', author: '苏轼', dynasty: '宋', text: '竹杖芒鞋轻胜马，谁怕？一蓑烟雨任平生。回首向来萧瑟处，归去，也无风雨也无晴。', appreciation: '苏轼的旷达人生观，写尽了从容与超然' },
        { title: '饮酒·其五', author: '陶渊明', dynasty: '晋', text: '结庐在人境，而无车马喧。问君何能尔？心远地自偏。采菊东篱下，悠然见南山。', appreciation: '田园诗的代表作，"心远"二字道出人生真谛' }
      ]
    },
    {
      name: '相思离别',
      icon: '💌',
      poems: [
        { title: '相思', author: '王维', dynasty: '唐', text: '红豆生南国，春来发几枝。愿君多采撷，此物最相思。', appreciation: '借红豆写相思，语浅情深，是相思诗的经典' },
        { title: '雨霖铃·寒蝉凄切', author: '柳永', dynasty: '宋', text: '多情自古伤离别，更那堪冷落清秋节。今宵酒醒何处？杨柳岸晓风残月。', appreciation: '写离别的千古绝唱，"杨柳岸晓风残月"已成为离愁的代名词' },
        { title: '一剪梅·红藕香残玉簟秋', author: '李清照', dynasty: '宋', text: '花自飘零水自流。一种相思，两处闲愁。此情无计可消除，才下眉头，却上心头。', appreciation: '李清照写相思的细腻入微，"才下眉头却上心头"神来之笔' },
        { title: '锦瑟', author: '李商隐', dynasty: '唐', text: '锦瑟无端五十弦，一弦一柱思华年。此情可待成追忆，只是当时已惘然。', appreciation: '最美的朦胧诗，千百年来众说纷纭，却人人读出己情' }
      ]
    },
    {
      name: '山水田园',
      icon: '🏔️',
      poems: [
        { title: '望岳', author: '杜甫', dynasty: '唐', text: '会当凌绝顶，一览众山小。', appreciation: '青年杜甫的豪情壮志，写泰山也写胸襟' },
        { title: '鹿柴', author: '王维', dynasty: '唐', text: '空山不见人，但闻人语响。返景入深林，复照青苔上。', appreciation: '王维"诗中有画"的典范，禅意空灵' },
        { title: '饮酒其五（节选）', author: '陶渊明', dynasty: '晋', text: '采菊东篱下，悠然见南山。山气日夕佳，飞鸟相与还。', appreciation: '田园生活的至高境界，"悠然"二字最难得' },
        { title: '题西林壁', author: '苏轼', dynasty: '宋', text: '横看成岭侧成峰，远近高低各不同。不识庐山真面目，只缘身在此山中。', appreciation: '写景中蕴含哲理，"身在此山中"已成常用典故' }
      ]
    },
    {
      name: '豪放壮志',
      icon: '⚔️',
      poems: [
        { title: '满江红·写怀', author: '岳飞', dynasty: '宋', text: '莫等闲，白了少年头，空悲切。', appreciation: '千古爱国名篇，激励无数后人珍惜时光' },
        { title: '破阵子·为陈同甫赋壮词以寄之', author: '辛弃疾', dynasty: '宋', text: '醉里挑灯看剑，梦回吹角连营。了却君王天下事，赢得生前身后名。可怜白发生！', appreciation: '壮志未酬的悲壮，最后五字令人扼腕' },
        { title: '龟虽寿', author: '曹操', dynasty: '汉', text: '老骥伏枥，志在千里。烈士暮年，壮心不已。', appreciation: '曹操的雄心壮志，年龄从不限制真正的豪情' },
        { title: '过零丁洋', author: '文天祥', dynasty: '宋', text: '人生自古谁无死？留取丹心照汗青。', appreciation: '气节与文采的完美统一，民族精神的丰碑' }
      ]
    }
  ]
};
...
/* ---------- 读书学习推荐书单 ---------- */
const ReadingList = [
  { title: '红楼梦', author: '曹雪芹', category: '古典文学', desc: '中国古典小说的巅峰，传统文化的百科全书', tags: ['古典', '人情', '诗词'] },
  { title: '人间词话', author: '王国维', category: '文学理论', desc: '以"境界"论词，打通中西的美学经典', tags: ['美学', '词论', '经典'] },
  { title: '唐诗三百首', author: '蘅塘退士编', category: '诗词集', desc: '入门唐诗的最佳选本，篇篇精华', tags: ['唐诗', '入门', '必读'] },
  { title: '宋词三百首', author: '上彊村民编', category: '诗词集', desc: '宋词选本中的经典，词之美尽在其中', tags: ['宋词', '入门', '必读'] },
  { title: '浮生六记', author: '沈复', category: '散文', desc: '清代文人的真实生活记录，平淡中有深情', tags: ['散文', '生活', '真实'] },
  { title: '世说新语', author: '刘义庆', category: '笔记小说', desc: '魏晋风度的最佳读本，短小精悍意味深长', tags: ['魏晋', '笔记', '趣味'] },
  { title: '菜根谭', author: '洪应明', category: '语录', desc: '修身处世的智慧箴言，嚼得菜根百事可做', tags: ['修身', '哲理', '语录'] },
  { title: '瓦尔登湖', author: '梭罗', category: '散文', desc: '回归自然的沉思录，精神生活的经典', tags: ['自然', '哲学', '慢生活'] }
];
